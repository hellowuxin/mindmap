...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".theme--light.v-icon{color:rgba(0,0,0,.54)}.theme--light.v-icon--disabled{color:rgba(0,0,0,.38)!important}.theme--dark.v-icon{color:#fff}.theme--dark.v-icon--disabled{color:hsla(0,0%,100%,.5)!important}.v-icon.v-icon{-webkit-box-align:center;-ms-flex-align:center;align-items:center;display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-font-feature-settings:\"liga\";font-feature-settings:\"liga\";font-size:24px;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;letter-spacing:normal;line-height:1;text-indent:0;-webkit-transition:.3s cubic-bezier(.25,.8,.5,1),visibility 0s;transition:.3s cubic-bezier(.25,.8,.5,1),visibility 0s;vertical-align:middle;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.v-icon.v-icon--dense{font-size:20px}.v-icon--right{margin-left:8px}.v-icon--left{margin-right:8px}.v-icon.v-icon.v-icon--link{cursor:pointer}.v-icon--disabled{pointer-events:none;opacity:.6}.v-icon--is-component,.v-icon--svg{height:24px;width:24px}.v-icon--svg{fill:currentColor}.v-icon--dense--is-component{height:20px}", ""]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "div#mindmap{font-size:14px;position:relative;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-shadow:0 3px 1px -2px rgba(0,0,0,.2),0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12);box-shadow:0 3px 1px -2px rgba(0,0,0,.2),0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12)}div#mindmap p{margin:0}div#mindmap foreignObject{padding:5px}div#mindmap div.rightClickTrigger{position:absolute;width:100%;height:100%}div#mindmap svg{-webkit-box-flex:1;-ms-flex:auto;flex:auto}div#mindmap svg rect.textRect:not(.depth_0){fill:#00f;fill-opacity:0;stroke:#00f;stroke-opacity:0;stroke-width:2}div#mindmap svg rect.textRect.depth_0{fill:#fff;stroke:#bec6f3;stroke-opacity:0;stroke-width:2}div#mindmap svg g.gButton{opacity:0}div#mindmap svg g.gButton>path{fill:#00f}div#mindmap svg g.gButton>rect{fill:#fff;stroke:grey;stroke-width:.5}div#mindmap svg path{fill:none;stroke-linecap:round;stroke-width:4}div#mindmap svg #selectedMindnode>rect.textRect:not(.depth_0){fill-opacity:1;opacity:.2;stroke-opacity:1}div#mindmap svg #selectedMindnode>rect.textRect.depth_0{stroke-opacity:1}div#mindmap svg #newParentNode>rect.textRect{stroke-opacity:.2}", ""]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".v-item-group{-webkit-box-flex:0;-ms-flex:0 1 auto;flex:0 1 auto;position:relative;max-width:100%;-webkit-transition:.3s cubic-bezier(.25,.8,.5,1);transition:.3s cubic-bezier(.25,.8,.5,1)}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"5f6d9cf7-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vuetify-loader/lib/loader.js??ref--18-0!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/MindMap.vue?vue&type=template&id=594cec60&
var MindMapvue_type_template_id_594cec60_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{style:(_vm.mmStyle),attrs:{"id":"mindmap"}},[_c('svg',[_c('g',{attrs:{"id":"content"}}),_c('g',{attrs:{"id":"dummy"}})]),_c('v-menu',{attrs:{"absolute":"","position-x":_vm.menuX,"position-y":_vm.menuY},model:{value:(_vm.showMenu),callback:function ($$v) {_vm.showMenu=$$v},expression:"showMenu"}},[_c('v-list',{staticClass:"py-1",attrs:{"dense":"","color":"grey lighten-3"}},_vm._l((_vm.items),function(item,index){return _c('v-list-item',{key:index,staticStyle:{"min-height":"20px"},on:{"click":function($event){return _vm.clickMenu(item)}}},[_c('v-list-item-title',[_vm._v(_vm._s(item.title))])],1)}),1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/MindMap.vue?vue&type=template&id=594cec60&
...
// CONCATENATED MODULE: ./src/JSONData.js
...
function breadthTraverse(d, c) {
  ...
  if (d.children) {
    ...
    for (var _index = 0; _index < d.children.length; _index += 1) {
      var _dChild = d.children[_index];
      breadthTraverse(_dChild, _dChild.color);
    }
  }
}
...
function () {
  ...
  _createClass(JSONData, [{
    ...
    value: function add(dParent, d) {
      // dParent添加子节点d
      var parent = this.getItself(dParent);
    ...
    value: function insert(dPosition, d) {
      ...
      var parent = this.getParent(dPosition);
...
/* harmony default export */ var src_JSONData = (JSONData_JSONData);
...
/* harmony default export */ var MindMapvue_type_script_lang_js_ = ({
  ...
  computed: {
    mmStyle: function mmStyle() {
      return {
        width: "".concat(this.width ? this.width : 700, "px"),
        height: "".concat(this.height ? this.height : 700, "px")
      };
    }
  },
  data: function data() {
  ...
  methods: {
    listenKeyDown: function listenKeyDown(event) {
      ...
      var sele = src_select('#selectedMindnode');
      ...
      if (keyName === 'Tab') {
        ...
        // 添加弟弟节点
        event.preventDefault();
        sele.each(function (d, i, n) {
          var mindmap_g = src_select('g#content');
    ...
    clickMenu: function clickMenu(item) {
      ...
      if (item.command === 0) {
        // 删除节点
        var sele = src_select('g#selectedMindnode');
        sele.each(function (d) {
          _this.mmdata.del(d.data);
        });
      }
    },
    ...
    depthTraverse: function depthTraverse(d, func) {
      // 深度遍历，func每个元素
      func(d);
    ...
    updateNodeName: function updateNodeName() {
      // 文本编辑完成时
      var editP = document.querySelector('#editing p');
      window.getSelection().removeAllRanges(); // 清除选中

      var editText = editP.textContent;
    ...
    drawMindnode: function drawMindnode(dJSON) {
      var mindmap_g = this.mindmap_g,
          easePolyInOut = this.easePolyInOut;
      var updateNodeName = this.updateNodeName,
          showContextMenu = this.showContextMenu;
      var root = null;
      var link = linkHorizontal().x(function (d) {
        return d[0];
      }).y(function (d) {
        return d[1];
      });

      function gBtnClick(d, i, n) {
        // 添加子节点
        on_event.stopPropagation(); // 阻止捕获和冒泡阶段中当前事件的进一步传播。

        src_select(n[i].parentNode).each(function (d) {
          var newJSON = {
            name: '新建节点',
            children: []
          };
      ...
      function rectTriggerOver(d, i, n) {
        ...
        if (n[i].className.baseVal.includes('gButton')) {
          ...
          var collection = n[i].parentNode.children;
          gBtn = src_select(collection[collection.length - 1]);
      ...
      function click(d, i, n) {
        ...
        var sele = document.getElementById('selectedMindnode');
        ...
        if (edit) {// 正在编辑
          ...
          src_select(sele).select('p').attr('contenteditable', true);
      ...
      function rightClick(d, i, n) {
        ...
        showContextMenu(on_event);
      }

      function dragged(d, i, n) {
        var draggedNode = n[i]; // 选中
        ...
        var py = on_event.x - subject.x;
        var px = on_event.y - subject.y;
        draggedNodeChildrenRenew(subject, px, py); // 相对subject.parent的坐标

        var targetY = subject.dy + py;
        var targetX = subject.dx + px;
        draggedNodeRenew(draggedNode, targetX, targetY, 0); // 重叠触发矩形边框

        var gSelection = mindmap_g.selectAll('g').filter(function (d, i, n) {
          return !draggedNode.isSameNode(n[i]) && !draggedNode.parentNode.isSameNode(n[i]);
        });
        gSelection.each(function (d, i, n) {
          var gNode = n[i];
          var gRect = gNode.getElementsByTagName('rect')[0];
          var rect = {
            // 各个gRect相对subject.parent的坐标，以及gRect的宽高
      ...
      function dragended(d, i, n) {
        ...
        if (draggedParentNode.isEqualNode(mindmap_g.nodes()[0])) {
          // 拖拽的是根节点时复原
      ...
      function appendNode(enter) {
        ...
        gNode.attr('class', function (d) {
          return "depth_".concat(d.depth);
        }).attr('transform', function (d) {
          return "translate(".concat(d.dy, ",").concat(d.dx, ")");
        });
        var foreign = gNode.append('foreignObject').attr('width', function (d) {
          return d.data.textWidth + 11;
        }).attr('height', 30).attr('transform', "translate(".concat(-5, ",").concat(-27, ")"));
        var foreignP = foreign.append('xhtml:p').attr('contenteditable', false).text(function (d) {
          return d.data.name;
        });
        foreignP.on('blur', updateNodeName);
        var rect = gNode.append('rect').attr('class', function (d) {
          return "depth_".concat(d.depth, " textRect");
        }).attr('y', -17 - 4).attr('x', -4).attr('width', function (d) {
          return d.data.textWidth + 8;
        }).attr('height', 16 + 8).attr('rx', 3).attr('ry', 3).lower();
        var rectTrigger = gNode.append('rect').attr('class', function (d) {
          return "depth_".concat(d.depth, " rectTrigger");
        }).attr('y', -17 - 8).attr('x', -8).attr('width', function (d) {
          return d.data.textWidth + 16;
        }).attr('height', 16 + 16).attr('opacity', 0).on('mouseover', rectTriggerOver).on('mouseout', rectTriggerOut).on('click', click).on('contextmenu', rightClick);
        var gBtn = gNode.append('g').attr('class', 'gButton').attr('transform', function (d) {
          return "translate(".concat(d.data.textWidth + 8, ",").concat(-12, ")");
        }).on('mouseover', rectTriggerOver).on('mouseout', rectTriggerOut).on('click', gBtnClick);
        ...
        if (enterData.length) {
          if (enterData[0].data.id !== '0') {
            gNode.append('path').attr('id', function (d) {
              return "path_".concat(d.data.id);
            }).attr('class', function (d) {
              return "depth_".concat(d.depth);
            }).lower().attr('stroke', function (d) {
              return d.data.color;
            }).attr('d', function (d) {
              return "".concat(link({
                source: [(d.parent ? d.parent.y + d.parent.data.textWidth : 0) - d.y, (d.parent ? d.parent.x : 0) - d.x],
                target: [0, 0]
              }), "L").concat(d.data.textWidth, ",0");
            });
          } else if (enterData[0].data.id === '0') {
            // 根节点
            foreign.attr('transform', "translate(".concat(-10, ",").concat(-15, ")"));
          ...
          gNode.each(function (d, i) {
            ...
            if (dd) {
              var gChildren = gNode.filter(function (a, index) {
                return i === index;
              }).selectAll("g".concat(dd[0] ? ".depth_".concat(dd[0].depth) : '')).data(dd).join(function (enter) {
              ...
              if (!dd[0] || dd[0].depth !== 0) {
                // 非根节点才可以拖拽
                gChildren.call(src_drag().on('drag', dragged).on('end', dragended));
              }
            }
          });
        }
      ...
      function updateNode(update) {
        update.attr('class', function (d) {
          return "depth_".concat(d.depth);
        }).transition(easePolyInOut).attr('transform', function (d) {
          return "translate(".concat(d.dy, ",").concat(d.dx, ")");
        });
        update.each(function (d, i, n) {
          ...
          node.select('rect.textRect').attr('class', "depth_".concat(d.depth, " textRect")).attr('width', d.data.textWidth + 8);
          node.select('rect.rectTrigger').attr('class', "depth_".concat(d.depth, " rectTrigger")).attr('width', function (d) {
            return d.data.textWidth + 16;
          });
          node.select('path').attr('id', "path_".concat(d.data.id)).attr('class', "depth_".concat(d.depth)).attr('stroke', d.data.color).transition(easePolyInOut).attr('d', "".concat(link({
            source: [(d.parent ? d.parent.y + d.parent.data.textWidth : 0) - d.y, (d.parent ? d.parent.x : 0) - d.x],
            target: [0, 0]
          }), "L").concat(d.data.textWidth, ",0"));
          node.each(function (d, i) {
            ...
            if (dd) {
              var gChildren = node.filter(function (a, index) {
                return i === index;
              }).selectAll("g".concat(dd[0] ? ".depth_".concat(dd[0].depth) : '')).data(dd).join(function (enter) {
                return appendNode(enter);
              }, function (update) {
          ...
          }).attr('transform', "translate(".concat(d.data.textWidth + 8, ",").concat(-12, ")")).raise();
        });
        return update;
      }
      ...
      function gNodeNest(d, gParent) {
        // 生成svg
        var gChildren = gParent.selectAll("g".concat(d[0] ? ".depth_".concat(d[0].depth) : '')).data(d).join(function (enter) {
          return appendNode(enter);
        }, function (update) {
          return updateNode(update);
        }, function (exit) {
      ...
      function renewY(r, textWidth) {
        ...
        if (r.children) {
          for (var index = 0; index < r.children.length; index += 1) {
            var rChild = r.children[index];
      ...
      function chart(d) {
        // 数据处理
        var r = hierarchy(d.data[0]); // 根据指定的分层数据构造根节点
        ...
        root = src_tree().nodeSize([r.nodeHeight, r.nodeWidth])(r);
        var x0 = Infinity;
        var x1 = -x0;
        renewY(root, 0);
        root.each(function (a) {
    ...
    getTextWidth: function getTextWidth(t) {
      var dummy_g = this.dummy_g;
      var textWidth = 0;
      dummy_g.selectAll('.dummyText').data([t.name]).enter().append("text").text(function (d) {
        return d;
      }).each(function (d, i, n) {
        var thisWidth = n[i].getComputedTextLength();
        textWidth = thisWidth;
  ...
  mounted: function mounted() {
    ...
    this.mmdata = new src_JSONData(this.value);
    this.mindmap_svg = src_select('div#mindmap svg');
    this.mindmap_g = src_select('g#content');
    this.mindmapSvgZoom = d3_zoom_src_zoom().scaleExtent([0.1, 8]).on('zoom', function () {
      var transform = on_event.transform;

      _this2.mindmap_g.attr('transform', transform);
    });
    this.mindmap_svg.call(this.mindmapSvgZoom).on('dblclick.zoom', null);
    this.dummy_g = src_select('g#dummy');
...
function helpers_defaultFilter(value, search, item) {
...
function searchItems(items, search) {
  ...
  return items.filter(function (item) {
    return Object.keys(item).some(function (key) {
      return helpers_defaultFilter(getObjectValueByPath(item, key), search, item);
    });
  });
}
/**
...
/* harmony default export */ var VList_VList = (VSheet_VSheet.extend().extend({
  ...
  computed: {
    classes: function classes() {
      return VList_objectSpread({}, VSheet_VSheet.options.computed.classes.call(this), {
...
function ripple_opacity(el, value) {
...
/* harmony default export */ var VList_VListItem = (baseMixins.extend().extend({
  ...
  render: function render(h) {
    ...
    data.attrs = VListItem_objectSpread({}, data.attrs, {}, this.genAttrs());
    data.on = VListItem_objectSpread({}, data.on, {
      click: this.click,
...
/* @vue/component */
  ...
  methods: {
    ...
    renderSvgIcon: function renderSvgIcon(icon, h) {
      ...
      var wrapperData = VIcon_objectSpread({}, this.getDefaultData(), {
        style: fontSize ? {
          fontSize: fontSize,
          height: fontSize,
          width: fontSize
  ...
  methods: {
    ...
    genHeader: function genHeader() {
      return this.$createElement(VList_VListItem, {
        ...
        on: VListGroup_objectSpread({}, this.listeners$, {
          click: this.click
        })
...
/* harmony default export */ var directives_resize = (Resize);
...
var VMenu_baseMixins = mixins(dependent, delayable, detachable, menuable, returnable, toggleable, themeable);
/* @vue/component */
  ...
  methods: {
    ...
    genContent: function genContent() {
      ...
      var options = {
        ...
        class: VMenu_objectSpread({}, this.rootThemeClasses, _defineProperty({
...
var component = normalizeComponent(
  ...
  MindMapvue_type_template_id_594cec60_render,
  staticRenderFns,
  false,
  null,
  null,
...
installComponents_default()(component, {VList: VList_VList,VListItem: VList_VListItem,VListItemTitle: VListItemTitle,VMenu: VMenu_VMenu})

// CONCATENATED MODULE: ./src/index.js

/* harmony default export */ var src = (MindMap);
